...
fun Ui(gptViewModel: GPTViewModel) {
    ...
    Column(verticalArrangement = Arrangement.Top) {
        Box(
            ...
            Text(
                text = "GPTalk",
                color = Color(0xFF404040), // Dark gray text color
                fontSize = 36.sp,
...
//                .padding(16.dp),
            ...
            OutlinedTextField(
                ...
                colors = TextFieldDefaults.outlinedTextFieldColors(
                    containerColor = Color(0xFFB0B0B0), // Light gray border
                    textColor = Color.White // Dark gray text color
                ),
                label = null,
                placeholder = { Text("Ask me anything", fontSize = 16.sp, color = Color.White) },
        ...
        Row(
            ...
            Button(
                ...
                Text(
                    text = "Send",
                    fontSize = 30.sp,
                    color = Color.White, // Dark gray text color
                )
            }
        ...
        Row(
            ...
            Box(
                modifier = Modifier
                    .fillMaxWidth()
                    .background(Color(0xFFB0B0B0)) // Light gray background
            ) {
